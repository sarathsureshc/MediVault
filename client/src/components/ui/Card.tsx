...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-2xl border border-slate-200/80 bg-white/95 backdrop-blur-sm text-slate-900 shadow-[0_2px_12px_-3px_rgba(15,23,42,0.06)] transition-all duration-200",
      className
    )}
    {...props}
  />
